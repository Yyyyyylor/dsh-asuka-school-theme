...
var WALLPAPER_ASSET_VERSION = "0.2.5";
...
function wallpaperOpacityForPeriod(opacity, period) {
...
function isBuiltInThemePreference(value) {
  return value === "light" || value === "dark" || value === "system";
}
function fallbackThemePreference(snapshot) {
...
function createAsukaThemeController(options) {
  ...
  let synchronouslyObservedOwnRevision;
  const deferredOwnThemeRevisions = /* @__PURE__ */ new Set();
  ...
  const mutateOwnTheme = (change) => {
    ...
    synchronouslyObservedOwnRevision = void 0;
  ...
  const syncTheme = () => {
    ...
    if (target === void 0) {
      ...
      if (previousTarget !== void 0 && preference === previousTarget) {
