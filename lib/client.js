...
function isActiveAsukaMode(mode) {
  return mode !== "off";
}
...
var WALLPAPER_URLS = Object.freeze({
...
var asukaLightTheme = {
  ...
  colorScheme: "light",
  tokens: {
    "--dsw-alias-bg-base": ASUKA_COLORS.warmCream,
    "--dsw-alias-bg-layer-1": ASUKA_COLORS.warmPaper,
...
var ASUKA_THEME_OVERRIDE_SOURCE = "asuka-school-theme";
function asukaThemeOverrides(mode) {
...
function createAsukaThemeController(options) {
  ...
  let wallpaperTimer;
  let clearThemeOverride;
  let appliedMode = "off";
  let baseThemePreference = String(theme.getTheme().preference);
  const ownThemeRevisions = /* @__PURE__ */ new Set();
  const mutateOwnTheme = (change) => {
  ...
  const syncThemeOverride = () => {
    ...
    mutateOwnTheme(() => {
      clearThemeOverride?.();
      clearThemeOverride = isActiveAsukaMode(current.mode) ? theme.overrideTokens(ASUKA_THEME_OVERRIDE_SOURCE, asukaThemeOverrides(current.mode)) : void 0;
    });
  ...
  return {
    setMode: (mode) => {
      if (isAsukaMode(mode)) void settings.set("mode", mode);
    },
...
var asukaLocales = {
  zh: {
    ...
    "section.afterClassDetail": "\u6696\u767D \xB7 \u6821\u670D\u84DD \xB7 \u9886\u7ED3\u7EA2",
  ...
  en: {
    ...
    "section.afterClassDetail": "Warm cream \xB7 school blue \xB7 ribbon red",
...
var MODES = ["off", "after-class", "tokyo3-night"];
function AsukaQuickRow({ t, useStore, setMode }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "asuka-quick-row", "aria-label": t("quick.label"), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "asuka-mode-switch", role: "group", "aria-label": t("quick.label"), children: MODES.map((mode) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "button",
      {
        ...
        children: mode === "off" ? t("mode.off") : mode === "after-class" ? t("mode.afterClass") : t("mode.tokyo3Night")
      },
      mode
    )) })
  ] });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "asuka-section", "aria-labelledby": "asuka-school-title", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("fieldset", { className: "asuka-setting-group", disabled, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "asuka-theme-cards", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ThemeCard, { mode: "after-class", selected: settings.mode === "after-class", onSelect: setMode, title: t("mode.afterClass"), detail: t("section.afterClassDetail") }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ThemeCard, { mode: "tokyo3-night", selected: settings.mode === "tokyo3-night", onSelect: setMode, title: t("mode.tokyo3Night"), detail: t("section.tokyo3NightDetail") }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("fieldset", { className: "asuka-setting-group", disabled: disabled || settings.mode === "off", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(RangeRow, { label: t("section.opacityLabel"), value: percentage, min: 0, max: 40, suffix: "%", onChange: (event) => setOpacity(Number(event.currentTarget.value) / 100) }),
