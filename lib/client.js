...
var TRANSITION_ATTRIBUTE = "data-asuka-school-transitioning";
var baseline;
var activeThemeId;
var transitionTimer;
...
function applyAsukaPresentation(mode, period = "noon", reduceMotion = false) {
  ...
  const shouldTransition = !reduceMotion && activeThemeId !== void 0 && activeThemeId !== definition.id;
  if (shouldTransition) {
...
var WALLPAPER_ASSET_VERSION = "0.2.8";
