...
const ASUKA_SETTINGS_NAMESPACE = ASUKA_SETTINGS_NAMESPACE_ID;
const AsukaThemeSettingsSchema = z.object({
	...
	wallpaperOpacity: z.number().min(0).max(1).step(.01).default(DEFAULT_ASUKA_SETTINGS.wallpaperOpacity),
...
const WALLPAPER_LAYER_PROFILES = Object.freeze({
	morning: {
